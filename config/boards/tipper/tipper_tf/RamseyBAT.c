 ...
 * Size: 20 px
 * Bpp: 1
 * Opts: --bpp 1 --size 20 --no-compress --stride 1 --align 1 --font RamseyTest-BlackCondensedItalic-BF64069d9ad0c68.ttf --symbols BAT123 --format lvgl -o Ramsey.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 11, .adv_w = 186, .box_w = 12, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 32, .adv_w = 182, .box_w = 12, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 53, .adv_w = 173, .box_w = 11, .box_h = 14, .ofs_x = -1, .ofs_y = 0},
    {.bitmap_index = 73, .adv_w = 181, .box_w = 12, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 94, .adv_w = 163, .box_w = 10, .box_h = 14, .ofs_x = 1, .ofs_y = 0}
};
...
{
    {
        .range_start = 49, .range_length = 36, .glyph_id_start = 1,
